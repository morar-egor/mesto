...
const formEditProfile = page.querySelector('.popup_type_edit-profile');
const formAddContent = page.querySelector('.popup_type_add-content');
const contentOpenPicture = page.querySelector('.popup_type_picture');
...
const closeButtonProfile = page.querySelector('.popup__close_type_edit-profile');
const closeButtonContent = page.querySelector('.popup__close_type_add-content');
const closeButtonPicture = page.querySelector('.popup__close_type_picture');
...
const contentTemplate = page.querySelector('#content__template');
